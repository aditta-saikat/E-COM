...
const ROLE_META = {
  customer: { label: 'Customer', icon: User, className: 'bg-indigo-50 text-indigo-700' },
  shop_admin: { label: 'Shop admin', icon: Store, className: 'bg-cyan-50 text-cyan-700' },
  admin: { label: 'Admin', icon: ShieldCheck, className: 'bg-rose-50 text-rose-700' },
}
...
const Profile = () => {
  ...
  return (
    <div className="mx-auto max-w-md px-6 py-8">
      <h1 className="font-display mb-6 text-2xl font-bold text-slate-900">Profile</h1>
